...
export function BodegonAd({ large = false }: { large?: boolean }) {
  return (
    <a
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            <div className="flex items-center gap-2 mb-1">
              <p className="text-base font-bold text-white">Bodegón de Bebidas</p>
            ...
            <p className="text-xs text-white/70">Distribuidora de Bebidas y Yerbas · Venta mayorista y minorista</p>
          </div>
        </div>
      ) : (
